...
import { panelMarkup, projectIndexMarkup } from './src/panels/panels';
  ...
  return {
    ...
    async transformIndexHtml(html) {
      ...
      return html
        ...
        .replace('<!-- index -->', projectIndexMarkup(content));
    },
  };
}

export default defineConfig({
  // The same build works at a custom-domain root and a GitHub project path.
  base: './',
